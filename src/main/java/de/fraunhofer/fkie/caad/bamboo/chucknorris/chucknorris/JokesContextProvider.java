package de.fraunhofer.fkie.caad.bamboo.chucknorris.chucknorris;
...
public class JokesContextProvider implements ContextProvider {

    private final ApplicationProperties applicationProperties;

    /**
     * Jokes are from
     * https://github.com/jenkinsci/chucknorris-plugin/blob/master/src/main/java/hudson/plugins/chucknorris/FactGenerator.java#L37
     **/
    ...
    public JokesContextProvider(ApplicationProperties applicationProperties){
